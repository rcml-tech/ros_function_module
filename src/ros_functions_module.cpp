...
Params[4] = FunctionData::FLOAT;                                   \
  \
ros_functions[function_id] =                                       \
      new FunctionData(function_id + 1, 5, Params, FUNCTION_NAME); \
  \
function_id++;
//////
...
Params[2] = FunctionData::FLOAT;                                   \
  \
ros_functions[function_id] =                                       \
      new FunctionData(function_id + 1, 3, Params, FUNCTION_NAME); \
  \
function_id++;
//////
...
Params[6] = FunctionData::FLOAT;                                   \
  \
ros_functions[function_id] =                                       \
      new FunctionData(function_id + 1, 7, Params, FUNCTION_NAME); \
  \
function_id++;
//////
...
Params[7] = FunctionData::FLOAT;                                   \
  \
ros_functions[function_id] =                                       \
      new FunctionData(function_id + 1, 8, Params, FUNCTION_NAME); \
  \
function_id++;
//////
...
FunctionResult *ROSFunctionModule::executeFunction(system_value function_index,
                                                   void **args) {
  ...
  try {
    switch (function_index) {
      ...
      case 15: {
        ...
        sendPose(input1, *input2, *input3, *input4, *input5, *input6, *input7,
                 *input8);
        break;
      }
      case 16: {
      ...
      case 18: {
        ...
        variable_value *input7 = (variable_value *)args[6];
        variable_value *input8 = (variable_value *)args[7];
        sendTransform(input1, *input2, *input3, *input4, *input5, *input6,
                      *input7, *input8);
        break;
      }
      case 19: {
      ...
      case 20: {
        ...
        variable_value *input6 = (variable_value *)args[5];
        variable_value *input7 = (variable_value *)args[6];
        sendWrench(input1, *input2, *input3, *input4, *input5, *input6,
                   *input7);
        break;
      }
      case 21: {
...
void ROSFunctionModule::prepare(colorPrintfModule_t *colorPrintf_p,
...
int ROSFunctionModule::startProgram(int uniq_index) { return 0; }
